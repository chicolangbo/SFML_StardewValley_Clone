...
void SceneEditor::Enter()
{
	...
	LayerFarm->SetText(stringTable->Get("LAYER_FARM"), 50, sf::Color::White, Origins::MC, 101, buttonLayerFarm->GetPosition().x + buttonLayerFarm->sprite.getGlobalBounds().width / 2, buttonLayerFarm->GetPosition().y + 23.f);
